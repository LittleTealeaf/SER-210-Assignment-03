 ...
 */
public class HarryPotterCharacter implements Parcelable {
     ...
     * @param in
     */
    protected HarryPotterCharacter(Parcel in) {
        name = in.readString();
     ...
     */
    public static final Creator<HarryPotterCharacter> CREATOR = new Creator<HarryPotterCharacter>() {
        @Override
        public HarryPotterCharacter createFromParcel(Parcel in) {
            return new HarryPotterCharacter(in);
        }

        @Override
        public HarryPotterCharacter[] newArray(int size) {
            return new HarryPotterCharacter[size];
        }
    };
